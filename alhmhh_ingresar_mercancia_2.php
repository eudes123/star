        ...
        <div class="col-xs-12 col-sm-8 col-md-8" style="padding:0;">
                ...
                <div class="container-fluid" style="padding:0;"> <!-- abre el container fluid de la barra de progreso -->
                        <div class="row" style="padding:0;"> 
                            <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-2 col-sm-offset-2 col-md-offset-2" style="font-size:12px; padding:0;">
                ...
                <div class="row">
                    <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-2 col-sm-offset-2 col-md-offset-2" style="padding:0;">
                        ...
                        <form class="form-inline" role="form" name="formulario" method="GET" action="alhmhh_ingresar_mercancia_3.php">
                                ...
                                <section class="col-xs-6 col-sm-6 col-md-6" style="padding:0;">    
                                    <div class="form-group datos_nueva_sucursal">
                                        ...
                                        <select name="ciudad" class="form-control" id="ci" style="width:195px;">
                                            ...
                                            <option value="1074" >Adidas</option>
                                            <option value="2" >Crocs</option>
                                            <option value="1076" >Puma</option>
                                            <option value="1075" >Reebook</option>
                                            <option value="1" >Vélez</option>
                                        </select>
                                    </div>
                                </section>
                                <br>
