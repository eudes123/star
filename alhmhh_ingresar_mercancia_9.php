    ...
    <div class="row">    
        ...
        <div class="col-xs-12 col-sm-8 col-md-8">
                ...
                <div class="container-fluid"> <!-- abre el container fluid de la barra de progreso -->
                        <div class="row"> 
                            <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-2 col-sm-offset-2 col-md-offset-2" style="font-size:11px;">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-xs-offset-3 col-sm-offset-3 col-md-offset-3">
                            <form class="form-inline" role="form" method="GET" action="alkhhh_ingresar_mercancia_cod_item.php">
                            <div class="form-group">
                                <label for="dd">Fecha de vencimiento:</label>
