<?php include ('aahikh_head_focus.php'); ?>
    ...
    <div class="row">    
        ...
        <div class="col-xs-12 col-sm-8 col-md-8" style="padding:0;">
                ...
                <div class="row">
                    <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-2 col-sm-offset-2 co2-md-offset-2" style="padding:0;">
                            
                        <form class="form-inline" role="form" name="formulario" method="GET" action="alhmrh_ingresar_mercancia_4.php" id="bill">

                            <section class="col-xs-12 col-sm-12 col-md-12" style="padding:0;">
                                <section class="col-xs-6 col-sm-6 col-md-6" style="padding:0;">    
                                    <div class="form-group">
                                        <label for="usr">Nueva lote: &nbsp;&nbsp;</label>
                                        <input type="text" class="form-control" id="codPr">
                                    </div>
                                </section>
