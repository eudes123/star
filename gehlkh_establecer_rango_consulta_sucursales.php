<?php include ('aahihh_head.php'); ?>
    ...
    <div class="row">    
        ...
        <div class="col-xs-12 col-sm-8 col-md-8" style="margin-topo:10px;">
            ...
            <br><br><br><br><br>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">   
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <form class="form-inline" role="form" method="GET" action="gehlmh_establecer_rango_consulta_sucursales_resultado.php">
