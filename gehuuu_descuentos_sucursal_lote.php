        ...
        <div class="col-xs-12 col-sm-8 col-md-8">
                ...
                <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-8 col-xs-offset-2 col-sm-offset-2 col-md-offset-2">   
                        ...
                        <form class="form-inline" role="form" name="formulario" method="GET" action="gehuuw_descuentos_sucursal_lote_vista.php">
                            <div class="form-group col-xs-6 col-sm-6 col-md-6">
                                   ...
                                   <select name="ciudad" class="form-control" name="" id="ci" style="width:195px;">
                                       ...
                                       <option value="1" >5545</option>
                                       <option value="1" >6910</option>
                                       <option value="1" >9047</option>
                                </select>
                            </div>                             
