                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">   
                        <div class="col-xs-12 col-sm-10 col-md-9 col-sm-offset-1 col-md-offset-2">
                            <form class="form-inline" role="form" method="GET" action="geihys_configuracion_sucursales_email_exito.php" id="bill">
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-sm-offset-1 col-md-offset-1" >
                                <label for="dd">Email sucursal: &nbsp;</label>
                                <input type="email" class="form-control" name="" id="codPr">
                            </div>
