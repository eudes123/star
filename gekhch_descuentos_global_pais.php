        ...
        <div class="col-xs-12 col-sm-8 col-md-8">
                ...
                <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-8 col-xs-offset-2 col-sm-offset-2 col-md-offset-2">   
                        ...
                        <form class="form-inline" role="form" name="formulario" method="GET" action="gekhdh_descuentos_global_pais_vista.php">
                            <div class="form-group col-xs-6 col-sm-6 col-md-6">
                                   <label for="ci">País:</label>
                                   <br>
                                   <select name="pais" class="form-control" id="ci" style="width:195px;">
